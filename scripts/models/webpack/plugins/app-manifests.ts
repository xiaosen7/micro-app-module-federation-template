...
export class AppManifestsPlugin implements WebpackPluginInstance {
  async apply(compiler: Compiler) {
    ...
    const modulePath = resolve(pathUtils.getMicroModulesDir(), 'src/app-manifests.ts');
    const code = dedent`
    /* eslint-disable prettier/prettier */
    ...
    compiler.getInfrastructureLogger(AppManifestsPlugin.name).info(`Create file ${modulePath}.`);
  }
}
